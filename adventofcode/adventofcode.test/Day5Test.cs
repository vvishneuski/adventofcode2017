...
namespace adventofcode.test
{
    ...
    public class Day5Test
    {
        ...
        [Test]
        [TestCaseSource(typeof(Day5Test), nameof(TestCases))]
        public int HowManyStepsWhileExit(int[] list, Func<int[], int, int> getOffset)
        {
            return Day5.HowManyStepsWhileExit(list, getOffset);
        }

        private static int[] TestList => SplitLines(Test).Select(int.Parse).ToArray();

        private static IEnumerable<string> SplitLines(string str)
        {
            return str.Split(new[] {Environment.NewLine}, StringSplitOptions.RemoveEmptyEntries);
        }

        private const string Test = @"2
0
0
1
2
