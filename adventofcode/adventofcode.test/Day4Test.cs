...
namespace adventofcode.test
{
    ...
    {
        [TestCase("aa bb cc dd", ExpectedResult = true)]
        [TestCase("aa bb cc aa", ExpectedResult = false)]
        public bool IsValidRegularPhrase(string phrase)
        {
            return Day4.RegularPhraseValidator(phrase);
        }
