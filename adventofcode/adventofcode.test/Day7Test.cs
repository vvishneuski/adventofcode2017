...
";
        ...
        [Test]
        [TestCaseSource(typeof(Day7Test), nameof(TestCases))]
        public string GetBottom(string programs)
        {
            return Day7.GetTowerName(programs);
        }
        ...
        [Test]
        [TestCaseSource(typeof(Day7Test), nameof(TestCases2))]
        public int FindDisbalanceDiscAndGetDifference(string programs)
        {
